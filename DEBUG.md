# Debugging @jc3212/opencode-models-discovery in OpenCode TUI
...
1. `[@jc3212/opencode-models-discovery] Model discovery plugin initialized` - Plugin loaded
...
1. **Is the plugin loaded?**
   - Look for: `[@jc3212/opencode-models-discovery] Model discovery plugin initialized`
...
**Check:**
1. Plugin is in `opencode.json`: `"plugin": ["@jc3212/opencode-models-discovery"]`
2. Plugin is installed: `npm list @jc3212/opencode-models-discovery`
