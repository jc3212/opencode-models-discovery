...
export class ToastNotifier {
  ...
  async success(message: string, title?: string, duration?: number): Promise<void> {
    try {
      if (!this.client?.tui?.showToast) {
        console.warn('[@jc3212/opencode-models-discovery] Toast API not available (client.tui.showToast missing)')
        return
      }
      ...
      console.error(`[@jc3212/opencode-models-discovery] Failed to show success toast`, error)
    }
  }
  ...
  async error(message: string, title?: string, duration?: number): Promise<void> {
    try {
      ...
      console.error(`[@jc3212/opencode-models-discovery] Failed to show error toast`, error)
    }
  }
  ...
  async warning(message: string, title?: string, duration?: number): Promise<void> {
    try {
      ...
      console.error(`[@jc3212/opencode-models-discovery] Failed to show warning toast`, error)
    }
  }
  ...
  async info(message: string, title?: string, duration?: number): Promise<void> {
    try {
      ...
      console.error(`[@jc3212/opencode-models-discovery] Failed to show info toast`, error)
    }
  }
  ...
  async progress(message: string, title?: string, progress?: number): Promise<void> {
    try {
      ...
      console.error(`[@jc3212/opencode-models-discovery] Failed to show progress toast`, error)
    }
  }
  ...
  async detailed(options: {
    ...
    try {
      ...
      console.error(`[@jc3212/opencode-models-discovery] Failed to show detailed toast`, error)
    }
  }
}
